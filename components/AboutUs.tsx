    ...
    />
      ...
      <div className="flex-1 pt-2 xl:pt-36 sm:px-16 px-2">
        ...
        <p className="text-[17px] text-[#191717] font-light mt-5">
          At Khalil Meals, we understand the hectic life of a student. Balancing
          classes, assignments, and extracurricular activities can leave little
          time for preparing healthy meals. That's where we come in.
        </p>
        <h1 className="2xl:text-[72px] sm:text-[64px] text-[60px] font-extrabold text-[#191717]">
          Our Mission
        </h1>
        <p className="text-[17px] text-[#191717] font-light mt-5">
          Our mission is to nourish the minds and bodies of students by offering
          convenient and nutritious meal solutions. We believe that everyone,
          especially students, should have access to delicious, well-balanced
          food that supports their health and lifestyle.
        </p>
